...
export const Theme = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6">
        <h3 className="text-xl font-semibold mb-2">Contador: {seconds} segundos</h3>
        <div className="flex space-x-4">
          <button
            onClick={handleStartCounter}
            className="bg-green-500 text-white px-6 py-2 rounded hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
          >
            Iniciar
          </button>
          <button
            onClick={handleStopCounter}
            className="bg-red-500 text-white px-6 py-2 rounded hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50"
          >
            Parar
          </button>
        </div>
